...
/** function class class를 이용한 요소(DOM 객체) 접근 방법 */
function classTest(){
...
/* 칸 나눠서 집어넣기(html, css div->div1,2로) 
    const div1 = document.getElementsByClassName("name-div1")[0];
    const div2 = document.getElementsByClassName("name-div2")[0];
  
    div1.innerHTML = `${str}`;
    div2.innerHTML = `선택된 취미 개수 : ${count}개`; */
...
function cssTest1(){
  ...
  // target-div 속성 값이 css-div인 요 소의
